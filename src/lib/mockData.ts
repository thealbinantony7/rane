...
export const messagesData: Record<string, Message[]> = {
  ...
  'conv-2': [
    ...
    {
      id: 'msg-g4',
      content: 'I think we should go with the gradient approach for buttons',
      senderId: 'me',
      timestamp: new Date(Date.now() - 1000 * 60 * 30),
      isRead: true,
    },
  ...
  'conv-3': [
    {
      id: 'msg-s1',
      content: 'Hey Sarah! Quick question about the project timeline.',
      senderId: 'me',
      timestamp: new Date(Date.now() - 1000 * 60 * 60),
      isRead: true,
    },
    ...
    {
      id: 'msg-s4',
      content: 'It\'s next Friday! We should have the prototype ready by then.',
      senderId: '2',
  ...
  'conv-4': [
    ...
    {
      id: 'msg-c2',
      content: 'Please check this channel regularly for important updates.',
      senderId: '4',
    ...
    {
      id: 'msg-c3',
      content: '🎉 We just hit 10,000 users! Thank you all for your support.',
      senderId: '4',
      timestamp: new Date(Date.now() - 1000 * 60 * 60 * 5),
  ...
  'conv-5': [
    {
      id: 'msg-j1',
      content: 'Hey Jordan, are you available for a quick sync?',
      senderId: 'me',
  ...
  'conv-6': [
    {
      id: 'msg-e1',
      content: 'Sprint planning starts at 10am tomorrow',
      senderId: '5',
    ...
    {
      id: 'msg-e2',
      content: 'Got it! I\'ll prepare the backlog items.',
      senderId: '3',
    ...
    {
      id: 'msg-e3',
      content: 'The API refactoring is almost done 💪',
      senderId: '5',
